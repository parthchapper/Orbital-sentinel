...
export const LOOP_DURATION_S = 180.0;
...
export const MODES = TIMELINE_SEGMENTS.map((s) => s.mode);
...
export const GROUND_STATIONS = [
  { id: 'DXB_GS', name: 'Dubai Primary', lat: 25.2048, lon: 55.2708, band: 'X', rate_mbps: 120 },
  { id: 'SVL_GS', name: 'Svalbard Polar', lat: 78.2290, lon: 15.4070, band: 'X', rate_mbps: 310 },
];
...
export default {
  SPACECRAFT, EPS, LOOP_DURATION_S, TIMELINE_SEGMENTS, MODES,
  DESAL_PLANTS, GROUND_STATIONS, AOI, SPECTRO,
};
